...
public class ResultsOrchestrator extends BaseOrchestrator {

    /**
     * Initializes a new instance of the {@link ResultsOrchestrator} class.
     *
     * @param config The mediator configuration.
     */
    public ResultsOrchestrator(MediatorConfig config) {
        super(config);
    }
    ...
    public void onReceive(Object msg) {
        if (msg instanceof MediatorHTTPRequest) {
            ...
            sendDataToCtc3(body, REQUEST_TYPE.RESULTS);
